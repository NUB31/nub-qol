...
public class ModConfig extends Config {
    public final IClientConfigEntry<Boolean> EELEnabled = new ClientToggleConfigEntry(storageProvider, "easyElytraLaunchEnabled", true, Text.translatable("nub-qol.config.eel_enabled.title"), Text.translatable("nub-qol.config.eel_enabled.description"));
    public final IClientConfigEntry<Boolean> EELMessagesEnabled = new ClientToggleConfigEntry(storageProvider, "easyElytraLaunchMessagesEnabled.", false, Text.translatable("nub-qol.config.eel_messages_enabled.title"), Text.translatable("nub-qol.config.eel_messages_enabled.description"));
